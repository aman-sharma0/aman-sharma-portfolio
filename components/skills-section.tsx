...
import { Shield, Settings, ScanEye, Wifi, Code, Monitor } from "lucide-react";
...
export function SkillsSection() {
  ...
  const skills = [
    ...
    {
      icon: ScanEye,
      title: "Vulnerability Assessment & Security Auditing",
      color: "cyber-green",
      items: [
          ...
          {skills.map((skill, index) => (
            <div
              ...
              data-testid={`skill-card-${skill.title
                ...
                .replace(/\s+/g, "-")}`}
            >
            <div className="flex gap-3 min-h-[3.5rem] mb-4">
